...
//index.js:
 import "./__farm_runtime.6463a55a.mjs";import "./bundle2.js";import * as __farm_external_module_node_fs from "node:fs";(globalThis || window || global)['__farm_default_namespace__'].__farm_module_system__.setExternalModules({"node:fs": {...__farm_external_module_node_fs,__esModule:true}});(function(_){for(var r in _){_[r].__farm_resource_pot__='index_03f1.js';(globalThis || window || global)['__farm_default_namespace__'].__farm_module_system__.register(r,_[r])}})({"39c59270":function  (module, exports, farmRequire, farmDynamicRequire) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    Object.defineProperty(exports, "readFileSync", {
        enumerable: true,
        get: function() {
            return _nodefs.readFileSync;
        }
    });
    var _export_star = farmRequire("@swc/helpers/_/_export_star");
    var _nodefs = _export_star._(farmRequire("node:fs"), exports);
}
,
"b5d64806":function  (module, exports, farmRequire, farmDynamicRequire) {
    ...
    _export(exports, {
        readFile: function() {
            return _exportNamed.readFile;
        },
        readFileSync: function() {
            return _exportNamed.readFileSync;
        },
        writeFileSync: function() {
            return _exportNamed.writeFileSync;
        }
    });
    var _export_star = farmRequire("@swc/helpers/_/_export_star");
    var _exportNamed = farmRequire("39c59270");
    _export_star._(farmRequire("d1a94858"), exports);
}
,});(globalThis || window || global)['__farm_default_namespace__'].__farm_module_system__.setInitialLoadedResources(['bundle2.js']);(globalThis || window || global)['__farm_default_namespace__'].__farm_module_system__.setDynamicModuleResourcesMap({  });var farmModuleSystem = (globalThis || window || global)['__farm_default_namespace__'].__farm_module_system__;farmModuleSystem.bootstrap();var entry = farmModuleSystem.require("b5d64806");var readFile=entry.readFile;export { readFile };var readFileSync=entry.readFileSync;export { readFileSync };var writeFileSync=entry.writeFileSync;export { writeFileSync };var bundle2A=entry.bundle2A;export { bundle2A };var bundle2B=entry.bundle2B;export { bundle2B };