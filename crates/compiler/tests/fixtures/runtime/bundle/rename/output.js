//index.js:
 (globalThis || window || global)['__farm_default_namespace__'] = {__FARM_TARGET_ENV__: 'browser'};function _getRequireWildcardCache(nodeInterop) {
...
const sameNameWithFile$1 = 1;
const sameNameWithFile_ts$1 = 2;
const exportExpr_ts_default$1 = 3;
function say() {
    console.log("hello");
}
var sameNameWithFile_ts$2 = {
    say: say
};

console.log({
    NamedNamespace: exportNamed_ts,
    namedA: namedA,
    namedB: namedB,
    namedC: namedC,
    DefaultNamed: exportNamed_ts_default,
    SameNameWithFileNamespace: sameNameWithFile_ts$2,
